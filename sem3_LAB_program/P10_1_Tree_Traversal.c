/*Write a program to create a binary search tree and implement following tree traversal methods
using recursion:
 In-order traversal
 Pre-order traversal
...
int main()
{
    ...
    while (1)
    {
        printf("\n1. Insertion 2. Pre-order 3. Post-order 4. In-order 5. Exit\nEnter your choice:");
        scanf("%d", &ch);
        switch (ch)
        {
        case 1:
        ...
        case 5:
            exit(0);
        default:
            printf("You have entered wrong opetion\n");
            break;
        }
    }
    return 0;
